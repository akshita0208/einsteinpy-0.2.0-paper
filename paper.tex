...
The EinsteinPy package is updated with significant changes and bug fixes in every release. The major releases contain new features or any significant changes

Following sections wl give a breif overview of every core module and some of their important functionalities.
\subsection{tensor}
\subsection{metric}
